try {
  ;(() => {
    ...
    const _e = {
      NODE_ENV: 'production',
      NODE_PATH: ['/Users/ai/.volta/tools/shared'],
      STORYBOOK: 'true',
      PUBLIC_URL: '.',
    }
    const a = __REACT__
    ...
    const sf = __STORYBOOK_TYPES__
    const { Addon_TypesEnum: Tr } = __STORYBOOK_TYPES__
    const pf = __STORYBOOK_API__
    const {
      ActiveTabs: hf,
      Consumer: ff,
      ManagerContext: gf,
    ...
    const Yf = __STORYBOOK_THEMING__
    const {
      CacheProvider: Kf,
      ClassNames: Jf,
      Global: Qf,
    ...
    const b8 = __STORYBOOK_COMPONENTS__
    const {
      A: E8,
      ActionBar: k8,
      AddonPanel: w8,
    ...
    const Vl = 'Bc2PgW_p'
    const sd = 'Bc2PgW_c'
    const Hl = ['#FFC700', '#FF0000', '#2E3191', '#41BBC7']
    const jl = 3500
    const Dl = 0.5
    const zl = 150
    const Ul = 'mix'
    ...
    function dd(e, t = {}) {
      ...
      let v = []
      const g = () => Mn(nt() * (hd - 1))
      const y = (f, E) => o !== 'rectangles' && (f === 'circles' || fd(E))
      function w(f, E) {
        const C = g()
        const Z = y(o, C)
        const M = (X, oe) => f.style.setProperty(X, oe + '')
        ;(M('--xlp', Ir(ka(Xl(E, 90) - 180), 0, 180, -m / 2, m / 2) + 'px'),
          M('--dc', r - Mn(1e3 * nt()) + 'ms'))
        const V = nt() < ud ? Yt(nt() * md, 2) : 0
        ;(M('--x1', V),
          M('--x2', -1 * V),
          M('--x3', V),
        ...
        const D = C.toString(2).padStart(3, '0').split('')
      ...
      function h() {
        ...
        for (const [f, E] of eo(v)) w(E, p[+f].degree)
        b = setTimeout(() => {
          c && (e.innerHTML = '')
        }, r)
      }
      return (
        ...
        {
          update(f) {
            const E = f.particleCount ?? zl
            const C = f.particleShape ?? Ul
            const Z = f.particleSize ?? $l
            const M = f.particleClass ?? Wl
            const V = f.colors ?? Hl
            const D = f.stageHeight ?? Gl
            const X = f.duration ?? jl
            const oe = f.force ?? Dl
            const ve = f.stageWidth ?? Yl
            const fe = f.destroyAfterDone ?? ql
            p = Ql(E, V)
            let ce = !1
            if (E === l) {
              v = Array.from(e.querySelectorAll(`.${Vl}`))
              for (const [be, { color: wt }] of eo(p)) {
                const ge = v[+be]
    ...
    var Mn = Math.round
    var pd = Math.max
    var Or = e => document.createElement(e)
    var _r = (e, t) => e.appendChild(t)
    var Ql = (e, t) =>
      Array.from({ length: e }, (n, r) => ({
        color: t[r % t.length],
        degree: (360 * r) / e,
      }))
    var Yt = (e, t = 2) => Mn((e + Number.EPSILON) * 10 ** t) / 10 ** t
    var Ir = (e, t, n, r, i) => ((e - t) * (i - r)) / (n - t) + r
    var Xl = (e, t) => (e + t > 360 ? e + t - 360 : e + t)
    var to = () => nt() > 0.5
    ...
    const bd = 'exponent'
    const Ed = 'function'
    const kd = 'Invalid number'
    const wd = 'Invalid rounding method'
    const Pr = 'jedec'
    const Cd = 'object'
    const Sd = 'round'
    const xd = 'kbit'
    ...
    function Hr(
      ...
      if (
        ...
        const X = f[0].toString()
        const oe = s || (X.match(/(\D)/g) || []).pop() || '.'
        const ve = X.toString().split(oe)
        const fe = ve[1] || ''
        const ce = fe.length
        const be = i - ce
    ...
    const Md = Object.create
    const D1 = Object.defineProperty
    const Fd = Object.getOwnPropertyDescriptor
    const Ad = Object.getOwnPropertyNames
    const Ld = Object.getPrototypeOf
    ...
    const Ui = At((e, t) => {
      ;(function (n, r) {
        ...
        function g(y, w, b) {
          const h = w === 1 ? g.singular(y) : g.plural(y)
          return (b ? w + ' ' : '') + h
        }
        return (
          (g.plural = p(o, l, n)),
    ...
    const _d = At((e, t) => {
      ...
      function o(c) {
        return function (u, m, p, v) {
          ...
          const y = u[c]
          const w = p.ease || s
          const b = isNaN(p.duration) ? 350 : +p.duration
          let h = !1
    ...
    const Id = At((e, t) => {
      ;(function (n, r) {
        ...
        function n(i) {
          const l = getComputedStyle(i, null).getPropertyValue('overflow')
          return l.includes('scroll') || l.includes('auto')
        }
        function r(i) {
          if (i instanceof HTMLElement || i instanceof SVGElement) {
            for (let l = i.parentNode; l.parentNode; ) {
              if (n(l)) return l
              l = l.parentNode
            }
    ...
    const U = 'chromaui/addon-visual-tests'
    const rn = `${U}/panel`
    const ci = `${U}/test-provider`
    const ui = `${U}/access-token/${pr}`
    const Wi = `${U}/configInfo`
    const io = `${U}/configInfoDismissed`
    const Dd = `${U}/gitInfo`
    const z1 = `${U}/gitInfoError`
    const U1 = `${U}/projectInfo`
    const $1 = `${U}/isOffline`
    const mi = `${U}/isOutdated`
    const zd = `${U}/startBuild`
    const Ud = `${U}/stopBuild`
    const W1 = `${U}/localBuildProgress`
    const $d = `${U}/selectedModeName`
    const Wd = `${U}/selectedBrowserId`
    const qd = `${U}/telemetry`
    const lo = `${U}/enableFilter`
    const q1 = `${U}/removeAddon`
    const Gd = 'chromatic'
    const Yd = `${U}/ChannelFetch/aborted`
    const Kd = `${U}ChannelFetch/request`
    const Jd = `${U}ChannelFetch/response`
    const Qd = {
      autoAcceptChanges: !1,
      exitOnceUploaded: !1,
      exitZeroOnChanges: !0,
    ...
    const G1 = 'https://www.chromatic.com/docs/visual-tests-addon'
    const ht = (e, t) => {
      const n = Gt(e)
    ...
    const Y1 = He(null)
    const Xd = ({ children: e, value: t }) =>
      a.createElement(Y1.Provider, { value: t }, e)
    const qi = () => ht(Y1, 'AuthState')
    const e5 = {
    ...
    const s5 = /^#[a-fA-F0-9]{6}$/
    const d5 = /^#[a-fA-F0-9]{8}$/
    const c5 = /^#[a-fA-F0-9]{3}$/
    const u5 = /^#[a-fA-F0-9]{4}$/
    const Dr =
    ...
    function J1(e) {
      ...
      const l = m5.exec(t.substring(0, 50))
      if (l)
        return {
          red: parseInt('' + l[1], 10),
      ...
      if (o) {
        ...
        const d = parseInt('' + o[2], 10) / 100
        const c = parseInt('' + o[3], 10) / 100
        const u = 'rgb(' + $n(s, d, c) + ')'
        const m = Dr.exec(u)
      ...
      const p = h5.exec(t.substring(0, 50))
      if (p) {
    ...
    function b5(e, t, n, r) {
      ...
      if (typeof e === 'object' && t === void 0 && n === void 0 && r === void 0)
        return e.alpha >= 1
          ...
          : 'rgba(' + $n(e.hue, e.saturation, e.lightness) + ',' + e.alpha + ')'
      throw new rt(2)
    }
    function gi(e, t, n) {
      if (
    ...
    function es(e, t, n) {
      return function () {
        const r = n.concat(Array.prototype.slice.call(arguments))
    ...
    function S5(e, t) {
      ...
      const n = Q1(t)
      return X1(Pa({}, n, { lightness: ns(0, 1, n.lightness - parseFloat(e)) }))
    }
    const x5 = ts(S5)
    const It = x5
    function N5(e, t) {
    ...
    const rs = Ct({ '0%, 100%': { opacity: 1 }, '50%': { opacity: 0.4 } })
    Ct({
    ...
    const Rt = { large: 40, medium: 28, small: 20, tiny: 16 }
    const L5 = k.div(
      {
    ...
    const T5 = k(Gi)(
      {
        ...
        display: 'block',
        verticalAlign: 'top',
        path: { fill: P.medium, animation: `${rs} 1.5s ease-in-out infinite` },
      },
      e => ({
    ...
    const Z5 = k.div(
      ...
      e =>
        ({
          tiny: { fontSize: `${B.size.s1 - 2}px`, lineHeight: `${Rt.tiny}px` },
          small: { fontSize: `${B.size.s1}px`, lineHeight: `${Rt.small}px` },
          medium: { fontSize: `${B.size.s2}px`, lineHeight: `${Rt.medium}px` },
    ...
    const I5 = k.a(
      {
        ...
        '&:active': { transform: 'translateY(0)', color: It(0.1, P.secondary) },
        svg: {
          display: 'inline-block',
          height: '1em',
          width: '1em',
    ...
    const Ne = W(({ children: e, withArrow: t, ...n }, r) => {
    ...
    const U5 = k(ke)({ width: '100%' })
    const $5 = k(Rl)({ width: 170 })
    const W5 = k.div({
      position: 'absolute',
      right: '0',
      minWidth: 45,
    ...
    const so = ({ error: e, value: t, lastErrorValue: n }) => {
    ...
    const ls = W(
      (
        ...
        const [h, f] = Le(so({ error: r, value: y, lastErrorValue: d }))
        const E = `${e}-error`
        te(() => {
          f(so({ error: r, value: y, lastErrorValue: d }))
        }, [y, r, d])
        const C = a.createElement(H5, {
    ...
    const os = W(({ type: e, startFocused: t, ...n }, r) => {
      const [i, l] = Le(e)
      const o = K(
        u => {
    ...
    const ec = k(({ active: e, activeColor: t, isLoading: n, ...r }) =>
      a.createElement('a', { ...r })
    )(Ki)
    const tc = k.span(Ki)
    const nc = G5(e =>
    ...
    const rc = e => window.btoa(Array.isArray(e) ? ac(e) : e)
    const uo = e =>
      rc(e).replace(/\+/g, '-').replace(/\//g, '_').replace(/=/g, '')
    const ic = e => Array.from(e.match(/.{1,2}/g) ?? [], t => parseInt(t, 16))
    const lc = () =>
    ...
    const ss = e =>
      Object.entries(e)
        ...
        .join('&')
    const oc = ({ error: e }) => e === 'authorization_pending'
    const sc = ({ error_description: e }) => e === 'Not OAuth beta user'
    const dc = async e => {
      const t = uo(lc())
      const n = uo(ic(Pn(t)))
      const r = await fetch(`${pr}/authorize`, {
        method: 'POST',
        headers: {
      ...
      const c = e ? o.replace('https://www', `https://${e}`) : o
      return {
    ...
    const cc = async ({ expires: e, device_code: t, verifier: n }) => {
      if (Date.now() >= e)
    ...
    const hr = He(null)
    const uc = ({ children: e, value: t }) =>
      a.createElement(hr.Provider, { value: t }, e)
    const Ve = (e, t) => {
      const n = ht(hr, 'Telemetry')
      te(() => n({ location: e, screen: t }), [e, t, n])
    }
    const mc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const ds = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const fr = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const pc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const hc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const fc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const cs = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const gc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const vc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const yc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const bc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Ji = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const mo = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Ec = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Qi = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const kc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const wc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const ln = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Cc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Sc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const us = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const xc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Nc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const ms = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Xi = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Ac = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Lc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Tc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Zc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const ps = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Oc = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const _c = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    const Ic = W(({ color: e = 'currentColor', size: t = 14, ...n }, r) =>
      S(
        'svg',
        {
          width: t,
    ...
    function hs() {
      const e = Zt()
      const { addNotification: t, setOptions: n, togglePanel: r } = e
      const i = K(
        ({ onDismiss: l }) => {
    ...
    function Be(e, t) {
      const n = K(() => {
        try {
          const s = sessionStorage.getItem(`${U}/state/${e}`)
          ...
          bi(
            ...
            s => {
              ...
              ;(s == null
                ...
                : (sessionStorage.setItem(`${U}/state/${e}`, JSON.stringify(s)),
                  d.add(e)),
    ...
    function Rc(...e) {
      const t = sessionStorage.getItem(`${U}/state`)?.split(';') || []
      e.length
    ...
    const gs = () => ht(fs, 'Uninstall Addon')
    const de = k.div({
      display: 'flex',
    ...
    const dt = k(Ol)(
      ...
      ({ active: e, theme: t }) => {
        const n = t.background.content === t.color.lightest
        const r = n ? 'rgb(241,248,255)' : 'rgb(28,37,45)'
        const i = n ? 'rgb(229,243,255)' : 'rgb(29,44,56)'
        return {
    ...
    const ys = k.div({ display: 'flex', flexDirection: 'column' })
    const Ei = k.div(({ theme: e }) => ({
      padding: 15,
      lineHeight: '18px',
    ...
    const Ha = k.div({ display: 'flex', fontWeight: 'bold', marginBottom: 15 })
    const po = k(Sc)(({ theme: e }) => ({
      width: 12,
      height: 12,
      margin: '3px 6px',
      verticalAlign: 'top',
    ...
    const Dc = k(ds)(gr)
    const zc = k(gc)(gr)
    const el = k(Qi)({ marginLeft: 'auto' })
    const tl = k(dt)({ margin: -5, marginLeft: 'auto' })
    const re = k(xn)(
      {
        '&&': {
          display: 'inline-flex',
    ...
    const Te = k(Zl)(({ theme: e }) => ({
      color: e.base === 'light' ? e.color.darker : e.color.lighter,
      border: `1px solid ${e.appBorderColor}`,
      fontSize: '12px',
      padding: '2px 3px',
    }))
    const ho = 'experimental_useSharedState_getValue'
    const Sa = 'experimental_useSharedState_setValue'
    const Ur = new Map()
    var bs = class {
      constructor(e) {
        ;((this.channel = e),
          ...
          this.channel.on(ho, t => {
            const n = this.state[t]?.index ?? 0
            const r = this.state[t]?.value
            this.channel.emit(Sa, t, r, n)
          }))
      }
      get(e) {
        return (this.state[e] || this.channel.emit(ho, e), this.state[e]?.value)
      }
      set(e, t) {
        const n = (this.state[e]?.index ?? 0) + 1
        ;((this.state[e] = { index: n, value: t }),
          this.channel.emit(Sa, e, t, n))
      }
      static subscribe(e, t) {
        const n = Ur.get(e) || new bs(t)
        return (
          Ur.has(e) ||
            (Ur.set(e, n),
            n.channel.on(Sa, (r, i) => {
    ...
    function we(e) {
      const t = Zt().getChannel()
      if (!t) throw new Error('Channel not available')
      const n = Ee(bs.subscribe(e, t))
      const [r, i] = Le(n.current.value)
      return (
        te(() => {
          const l = n.current
    ...
    const $c = k(tl)({ position: 'absolute', right: 16, top: 10 })
    const Wc = k.div(({ theme: e }) => ({
    ...
    const qc = k.div({ margin: '0 auto', maxWidth: 600, width: '100%' })
    const fo = k.div(({ theme: e }) => ({
      borderBottom: `1px solid ${e.appBorderColor}`,
      marginBottom: 20,
      paddingBottom: 20,
      code: { fontSize: '90%' },
    }))
    const Gc = k(Ha)({ marginBottom: 10 })
    const Yc = k.div({ display: 'flex', flexDirection: 'column', gap: 20 })
    const go = k.div(({ theme: e }) => ({
      alignItems: 'center',
    ...
    const yo = k.div(({ theme: e }) => ({
      fontWeight: e.typography.weight.bold,
      div: { marginLeft: 5, position: 'relative', top: 2 },
    }))
    const bo = k.div({ marginTop: 10 })
    const Kc = k.div(({ hideBorderRadius: e, theme: t }) => ({
    ...
    const Jc = k.div(({ theme: e }) => ({ color: e.color.warningText }))
    const Eo = k.div(({ theme: e }) => ({
      color: e.base === 'dark' ? e.color.medium : e.color.dark,
      marginTop: 2,
    }))
    const ko = k.div(({ warning: e, theme: t }) => ({
      alignItems: 'center',
      display: 'flex',
      backgroundColor: e
        ? t.base === 'dark'
    ...
    const Qc = k.div(({ theme: e }) => ({
      '&:nth-last-of-type(2)': {
        borderBottom: `1px solid ${e.appBorderColor}`,
        paddingBottom: 30,
      },
    }))
    const Es = { height: 12, margin: 2, verticalAlign: 'top', width: 12 }
    const Xc = k(Nc)(Es)
    const eu = k(bc)(Es)
    const tu = ({ onClose: e }) => {
      const { uninstallAddon: t } = gs()
      const [n] = we(Wi)
      const {
        configuration: r = {},
        problems: i = {},
      ...
      const { configFile: o, ...s } = r
      const d = Object.keys({ ...s, ...i, ...l })
        .sort()
        .map(c => ({
          key: c,
                ...
                a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      ...
                      c in Qd &&
                        a.createElement(Jc, null, '*Disabled for local builds')
                    ),
    ...
    const au = (e, t) => nu[t.type](e, t.payload)
    const ws = He(ks)
    const Cs = He(() => {})
    const vr = () => ht(ws, 'Controls')
    const vn = () => {
      const e = ht(Cs, 'ControlsDispatch')
      return ft(
        () => ({
    ...
    const ru = ({ children: e, initialState: t = ks }) => {
      const [n, r] = Cl(au, t)
      return a.createElement(
        ws.Provider,
        { value: n },
    ...
    const Ie = k(ba)({ marginBottom: '-4px', marginTop: '-4px', left: -8 })
    const iu = k.div({ '& > div': { minWidth: 120 } })
    function Ss(e) {
      return t =>
        Array.isArray(t)
          ? t.map(Ss(e))
    ...
    const Wn = ({ children: e, links: t, note: n, ...r }) => {
      ...
      const o = a.createElement(
        ...
        typeof e === 'function' ? e(i) : a.createElement(dt, { active: i }, e)
      )
      return n
        ? a.createElement(
            ke,
    ...
    const yr = () => {
      const { accessToken: e, setAccessToken: t, subdomain: n } = qi()
      const { toggleConfig: r } = vn()
      const [i] = we(U1)
      const l = va(U)
      const { projectId: o } = i || {}
      const s = [
    ...
    const Hn = k.div(({ grow: e }) => e && { flexGrow: e ? 1 : 'auto' })
    const Vn = k.div(
    ...
    const ou = k(Vn)({ alignItems: 'center', height: 40, margin: '0 10px' })
    const Ue = k.div(
      { display: 'flex', flexDirection: 'column', alignItems: 'center' },
      ({ push: e }) => e && { marginLeft: 'auto' }
    )
    const wo = k.div(({ theme: e }) => ({
      borderBottom: `1px solid ${e.appBorderColor}`,
      display: 'flex',
      alignItems: 'center',
      minHeight: 40,
    ...
    const su = k(Hn)(({ theme: e }) => ({
      background: e.background.warning,
      color: e.color.warningText,
    }))
    const du = k(Hn)(({ theme: e }) => ({
    ...
    const cu = ({
      ...
      const [i] = we(Wi)
      const l = Object.keys(i?.problems || {})
      const o = Object.keys(i?.suggestions || {})
      const [s, d] = Le(() => !!localStorage.getItem(io))
      const c = K(() => {
          ...
          ? a.createElement(
              ...
              a.createElement(
                ...
                a.createElement(
                  Ue,
                  { push: !0 },
                  a.createElement(dt, { onClick: c }, a.createElement(Qi, null))
                )
              )
            )
          : null
    ...
    const Co = k.div(({ hidden: e, interstitial: t, theme: n }) => ({
    ...
    const pe = ({
      ...
      const { configVisible: l } = vr()
      const { toggleConfig: o } = vn()
      const s = K(
        d => {
          ;(o(!0),
            d &&
    ...
    const hu = ({ value: e, placeholder: t, suffix: n }) =>
      a.createElement(
        pu,
        null,
    ...
    const fu = ({ id: e, value: t, placeholder: n, suffix: r, ...i }) =>
      a.createElement(
        mu,
        null,
        a.createElement(os, {
    ...
    const gu = k(ne)({ alignSelf: 'stretch' })
    const vu = k(vs)({
      width: 40,
      height: 40,
    ...
    const Eu = ({ onBack: e, onSignIn: t }) => {
      const [n, r] = Le('')
      const [i, l] = Le(null)
      const o = K(d => {
        const c = d.target.value.replace(/[^a-z0-9-]/g, '')
        ;(r(c), l(null))
      }, [])
      const s = K(
        d => {
    ...
    const wu = ({ onBack: e, onSignIn: t, onSignInWithSSO: n }) =>
      a.createElement(
        pe,
        { footer: null, ignoreConfig: !0 },
        a.createElement(nl, { onBack: e }),
...
`),
    ...
    const xs = /[_A-Za-z]\w*/y
    function ut() {
      let e
      if ((e = Re(xs))) return { kind: 'Name', value: e }
    }
    const xu = /(?:null|true|false)/y
    const Ns = /\$[_A-Za-z]\w*/y
    const Nu = /-?\d+/y
    const Mu = /(?:\.\d+)?[eE][+-]?\d+|\.\d+/y
    const Fu = /\\/g
    const Au = /"""(?:"""|(?:[\s\S]*?[^\\])""")/y
    ...
    const Bu = /(?:query|mutation|subscription)/y
    function Pu() {
      let e
      let t
      let n = []
...
"""`
    ...
    var Se = {
      ...
      VariableDefinition(e) {
        let t = Se.Variable(e.variable) + ': ' + De(e.type)
        return (
      ...
      Field(e) {
        let t = (e.alias ? e.alias.value + ': ' : '') + e.name.value
        if (je(e.arguments)) {
          const n = e.arguments.map(Se.Argument)
          const r = t + '(' + n.join(', ') + ')'
          t =
            r.length > 80
              ? t +
        ...
        ;(t(s => {
          ...
          n(
            Je(s => {
              if (s === 1) {
                o || ((o = !0), i(1))
                for (let d = 0, c = r, u = r.length; d < u; d++) c[d](1)
                r.length = 0
              } else {
                !o && !l ? ((l = !0), i(0)) : (l = !1)
                for (let m = 0, p = r, v = r.length; m < v; m++) p[m](0)
              }
            })
          ))
      }
      ...
      return i => {
        ;(t.push(i),
          t.length === 1 &&
            e(l => {
              if (l === 0) {
                for (let o = 0, s = t, d = t.length; o < d; o++) s[o](0)
                t.length = 0
              } else if (l.tag === 0) n = l[0]
              else {
                r = !1
                for (let c = 0, u = t, m = t.length; c < m; c++) u[c](l)
              }
            }),
          i(
            Je(l => {
    ...
    const Gu = e =>
      e && e.message && (e.extensions || e.name === 'GraphQLError')
        ...
        : typeof e === 'object' && e.message
          ...
          : new ki(e)
    const ll = class extends Error {
      constructor(e) {
        const t = (e.graphQLErrors || []).map(Gu)
        const n = ((r, i) => {
          let l = ''
...
`),
    ...
    const Qt = e => {
      ...
      if (Array.isArray(e)) {
        let t = '['
        for (const n of e) (t.length > 1 && (t += ','), (t += Qt(n) || 'null'))
        return (t += ']')
      } else if (
        ($a !== dn && e instanceof $a) ||
      ...
      if (
        ...
        const i = Fo.get(e) || Math.random().toString(36).slice(2)
    ...
    const Ni = (e, t, n) => {
      if (!(n == null || typeof n !== 'object' || n.toJSON || Pt.has(n)))
        if (Array.isArray(n))
          for (let r = 0, i = n.length; r < i; r++) Ni(e, `${t}.${r}`, n[r])
        else if (n instanceof $a || n instanceof Wa) e.set(t, n)
        else {
          Pt.add(n)
          for (const l of Object.keys(n)) Ni(e, `${t}.${l}`, n[l])
        }
    }
    const Ua = e => (Pt.clear(), Qt(e))
    var dn = class {}
    var $a = typeof File < 'u' ? File : dn
    var Wa = typeof Blob < 'u' ? Blob : dn
    const Yu = /("{3}[\s\S]*"{3}|"(?:\\.|[^"])*")/g
    const Ku = /(?:#[^\n\r]+)?(?:[\r\n]+|$)/g
    const Ju = (e, t) =>
      t % 2 == 0
...
`
        ...
        : e
    const Ao = e => e.split(Yu).map(Ju).join('').trim()
    const Lo = new Map()
    const Ra = new Map()
    const ol = e => {
      let t
...
# ${n}`,
    ...
    const Mi = (e, t) => {
      if (
        ...
        for (const n of Object.keys(t)) e[n] = Mi(e[n], t[n])
        return e
      }
      return t
    }
    const Xu = (e, t, n, r) => {
      let i = e.error ? e.error.graphQLErrors : []
      let l = !!e.extensions || !!t.extensions
      const o = { ...e.extensions, ...t.extensions }
      let s = t.incremental
      'path' in t && (s = [t])
      const d = { data: e.data }
      if (s) {
    ...
    const t2 = (e, t) => {
      const n = e.kind === 'query' && e.context.preferGetMethod
    ...
    const n2 = (e, t) => {
      if (t && !(e.kind === 'query' && e.context.preferGetMethod)) {
        ...
        if (r.size) {
          ...
          let l = 0
          for (const o of r.values()) i.append('' + l++, o)
          return i
        }
        return n
      }
    ...
    const a2 = (e, t) => {
      ...
      const r =
        (typeof e.context.fetchOptions === 'function'
          ...
          : e.context.fetchOptions) || {}
      if (r.headers)
        for (const i in r.headers) n[i.toLowerCase()] = r.headers[i]
      const l = n2(e, t)
      return (
        typeof l === 'string' &&
          !n['content-type'] &&
    ...
    const r2 = typeof TextDecoder < 'u' ? new TextDecoder() : null
    const i2 = /boundary="?([^=";]+)"?/i
    const l2 = /data: ?([^\n]+)/
    const Oo = e =>
    ...
    async function* _o(e) {
      if (e.body[Symbol.asyncIterator])
        for await (const t of e.body) yield Oo(t)
      else {
...
`
    ...
    const c2 =
      ...
      n => {
        const r = Da(l => {
          ...
          const s = t2(l, o)
          const d = a2(l, o)
          const c = Ls(Ze(u => u.kind === 'teardown' && u.key === l.key)(n))(
            s2(l, s, d)
          )
          return c
        })(
    ...
    const h2 = function e(t) {
      ...
      const p = h => {
        let f = Ls(Ze(E => E.kind === 'teardown' && E.key === h.key)(d.source))(
          Ze(
            E =>
        ...
        return (
          t.maskTypename && (f = wi(E => ({ ...E, data: Fi(E.data, !0) }))(f)),
          h.kind !== 'query'
      ...
      const v = this instanceof e ? this : Object.create(e.prototype)
      var g = Object.assign(v, {
        ...
        executeQuery(h, f) {
          const E = g.createRequestOperation('query', h, f)
          return g.executeRequestOperation(E)
        },
        executeSubscription(h, f) {
          const E = g.createRequestOperation('subscription', h, f)
          return g.executeRequestOperation(E)
        },
        executeMutation(h, f) {
          const E = g.createRequestOperation('mutation', h, f)
          return g.executeRequestOperation(E)
        },
        readQuery(h, f, E) {
          let C = null
      ...
      const y = d2
      const w = u2(t.exchanges)
      var b = Gn(
        w({ client: g, dispatchDebug: y, forward: p2({ dispatchDebug: y }) })(
          d.source
        )
      )
      return (qu(b), g)
    ...
    const v2 = (e, t) => e === t || !(!e || !t || e.key !== t.key)
    const $r = (e, t) => {
      const n = {
        ...e,
        ...t,
      ...
      return ((r, i) => {
        for (const l in r) if (!(l in i)) return !0
        for (const o in i)
    ...
    const y2 = (e, t) => {
      for (let n = 0, r = t.length; n < r; n++) if (e[n] !== t[n]) return !0
      return !1
    }
    function Ga(e, t) {
      e(t)
    ...
    const k2 = (e, t) =>
      t && t.suspense !== void 0 ? !!t.suspense : e.suspense
    function dl(e) {
      const t = sl()
      const n = E2(t)
      const r = k2(t, e.context)
      const i = b2(e.query, e.variables)
      const l = ft(() => {
        if (e.pause) return null
        const p = t.executeQuery(i, {
      ...
      const s = [t, i, e.requestPolicy, e.context, e.pause]
      const [d, c] = Le(() => [l, $r(Ai, o(l, r)), s])
      let u = d[1]
      ...
      const m = K(
        p => {
          const v = { requestPolicy: e.requestPolicy, ...e.context, ...p }
          Ga(c, g => [
            r
              ? za(y => {
                  n.set(i.key, y)
    ...
    const Wr = (e, t) => qa(e.kind, e, { ...e.context, authAttempt: t })
    function _2(e) {
          ...
          function p() {
            c = Promise.resolve()
              .then(() =>
                e({
                  mutate(b, h, f) {
                    const E = t.createRequestOperation('mutation', nn(b, h), f)
                    return il(
                      kr(1)(
                        Ze(
                          C =>
    ...
    const Bo = { randomUUID: P2 }
    function V2(e, t, n) {
      if (Bo.randomUUID && !t && !e) return Bo.randomUUID()
      e = e || {}
      const r = e.random ?? e.rng?.() ?? B2()
    ...
    const Ya = e => {
      try {
        const { exp: t } = e ? JSON.parse(atob(e.split('.')[1])) : { exp: null }
        ;((it = e), (Dn = t))
      } catch {
        ;((it = null), (Dn = null))
      }
    ...
    const Bs = () => {
      const [{ token: e }, t] = Ml(`${U}/accessToken`, { token: it })
        ...
        exchanges: [
          ...
          _2(async t => ({
            ...
            willAuthError() {
              ...
              try {
                if (!Dn) {
                  const { exp: n } = JSON.parse(atob(it.split('.')[1]))
                  Dn = n
                }
    ...
    const D2 = ({ children: e, value: t = Vs() }) =>
    ...
    const z2 = e => JSON.stringify(e, null, 2).replace(/"([^"]+)":/g, '$1:')
    const Ye = class extends Error {
      constructor(e) {
        ;(super(),
          (this.issues = []),
          (this.addIssue = n => {
    ...
    const Ja = e => {
      ...
      const d = r
        ...
        .slice()
        .reverse()
      for (const c of d) s = c(o, { data: t, defaultError: s }).message
    ...
    const js = e => ({ status: 'dirty', value: e })
    const Ae = e => ({ status: 'valid', value: e })
    const Ti = e => e.status === 'aborted'
    const Zi = e => e.status === 'dirty'
    const Kn = e => e.status === 'valid'
    const Qa = e => typeof Promise < 'u' && e instanceof Promise
    let R
    ;(function (e) {
    ...
    const Po = (e, t) => {
      ...
      return {
        ...
        get error() {
          ...
          const n = new Ye(e.common.issues)
    ...
    const Y = class {
      ...
      safeParse(e, t) {
        ...
        const i = this._parseSync({ data: e, path: r.path, parent: r })
        return Po(r, i)
      }
      ...
      async safeParseAsync(e, t) {
        ...
        const r = this._parse({ data: e, path: n.path, parent: n })
        const i = await (Qa(r) ? r : Promise.resolve(r))
        return Po(n, i)
      }
      refine(e, t) {
        const n = r =>
        ...
        return this._refinement((r, i) => {
          const l = e(r)
          const o = () => i.addIssue({ code: x.custom, ...n(r) })
      ...
      brand() {
        return new zs({ typeName: H.ZodBranded, type: this, ...$(this._def) })
      }
      catch(e) {
        const t = typeof e === 'function' ? e : () => e
        return new ar({
    ...
    const W2 = /^c[^\s-]{8,}$/i
    const q2 = /^[a-z][a-z0-9]*$/
    const G2 = /^[0-9A-HJKMNP-TV-Z]{26}$/
    const Y2 =
      /^[0-9a-fA-F]{8}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{4}\b-[0-9a-fA-F]{12}$/i
    const K2 =
      /^(?!\.)(?!.*\.\.)([A-Z0-9_+-\.]*)[A-Z0-9_+-]@([A-Z0-9][A-Z0-9\-]*\.)+[A-Z]{2,}$/i
    const J2 = '^(\\p{Extended_Pictographic}|\\p{Emoji_Component})+$'
    let Gr
    const Q2 =
    ...
    function nm(e, t) {
      ...
      const i = n > r ? n : r
      const l = parseInt(e.toFixed(i).replace('.', ''))
      const o = parseInt(t.toFixed(i).replace('.', ''))
    ...
    var ct = class extends Y {
      _parse(e) {
        ...
        if (r.exactLength !== null) {
          const l = t.data.length > r.exactLength.value
    ...
    var he = class extends Y {
      ...
      _parse(e) {
        ...
        const { shape: r, keys: i } = this._getCached()
        const l = []
        if (
          !(
          ...
          for (const s in n.data) i.includes(s) || l.push(s)
        const o = []
        for (const s of i) {
          const d = r[s]
          const c = n.data[s]
    ...
    var ea = class extends Y {
      _parse(e) {
        ...
        function r(i) {
          ...
          const l = i.map(o => new Ye(o.ctx.common.issues))
          ...
          ).then(r)
        {
          ...
          for (const s of n) {
            ...
            const c = s._parseSync({ data: t.data, path: t.path, parent: d })
    ...
    function Oi(e, t) {
      ...
      if (n === F.object && r === F.object) {
        const i = ae.objectKeys(t)
        const l = ae.objectKeys(e).filter(s => i.includes(s))
        const o = { ...e, ...t }
        for (const s of l) {
          const d = Oi(e[s], t[s])
    ...
    var tr = class extends Y {
      ...
      static create(e, t, n) {
        return t instanceof Y
          ? new tr({ keyType: e, valueType: t, typeName: H.ZodRecord, ...$(n) })
          : new tr({
              keyType: lt.create(),
              valueType: e,
    ...
    const nr = class extends Y {
      ...
      _parse(e) {
        ...
        const l = [...n.data.entries()].map(([o, s], d) => ({
      ...
      _parse(e) {
        ...
        if (this._def.returns instanceof pn) {
          ...
          return Ae(async function (...s) {
            const d = new Ye([])
            const c = await o._def.args.parseAsync(s, i).catch(m => {
              throw (d.addIssue(n(s, m)), d)
            })
            const u = await Reflect.apply(l, this, c)
          ...
          return Ae(function (...s) {
            const d = o._def.args.safeParse(s, i)
            if (!d.success) throw new Ye([n(s, d.error)])
            const c = Reflect.apply(l, this, d.data)
            const u = o._def.returns.safeParse(c, i)
    ...
    var Dt = class extends Y {
      _parse(e) {
        ...
        if (!this._def.values.includes(e.data)) {
          const t = this._getOrReturnCtx(e)
          const n = this._def.values
          return (
    ...
    var ra = class extends Y {
      _parse(e) {
        const t = ae.getValidEnumValues(this._def.values)
        const n = this._getOrReturnCtx(e)
        if (n.parsedType !== F.string && n.parsedType !== F.number) {
          const r = ae.objectValues(t)
          return (
            T(n, {
    ...
    var ar = class extends Y {
      _parse(e) {
        const { ctx: t } = this._processInputParams(e)
        const n = { ...t, common: { ...t.common, issues: [] } }
    ...
    const am = Symbol('zod_brand')
    var zs = class extends Y {
      _parse(e) {
        const { ctx: t } = this._processInputParams(e)
        const n = t.data
            ...
            if (!e(r)) {
              ...
              const d =
                ...
                o !== void 0
                  ? o
                  : !0
              const c = typeof s === 'string' ? { message: s } : s
              i.addIssue({ code: 'custom', ...c, fatal: d })
            }
          })
        : un.create()
    const rm = { object: he.lazycreate }
    let H
    ;(function (e) {
    ...
    const im = (e, t = { message: `Input not instance of ${e.name}` }) =>
    ...
    const Zm = yt.create
    const Om = zt.create
    const _m = Ke.createWithPreprocess
    const Im = Cr.create
    const Rm = () => $s().optional()
    const Bm = () => Ws().optional()
    const Pm = () => qs().optional()
    const Vm = {
        ...
        [
          K(r => {
            if (window.innerWidth > 800 && window.innerHeight > 800) {
              const l = (window.innerWidth - 800) / 2 + window.screenLeft
              const o = `scrollbars=yes,width=800,height=800,top=${(window.innerHeight - 800) / 2 + window.screenTop},left=${l}`
...
`)
    const Um = ({
      ...
      const l = sl()
      const o = hs()
      const { user_code: s, verificationUrl: d } = i
      const c = Ee()
      const u = Ee()
      const m = Ee()
      const p = K(
        async y => {
          if ((y.message === 'login' && u.current?.(d), y.message === 'grant'))
            try {
              const w = await cc(i)
              if (!w) throw new Error('Failed to fetch an access token')
              c.current = w
              const b = Ps(w)
              const { data: h } = await l.query(zm, {}, { fetchOptions: b })
              if (!h?.viewer)
                throw new Error('Failed to fetch initial project list')
              if (h.viewer.projectCount > 0 || t) (n(c.current), m.current?.())
              else {
    ...
    const Gm = k.div({ display: 'flex', gap: 8 })
    const Ym = k.div({ display: 'flex', flexDirection: 'column', gap: 8 })
    const Km = k.div(({ theme: e }) => ({
      display: 'flex',
      flexDirection: 'column',
      maxWidth: 400,
      overflow: 'hidden',
    ...
    const Qm = ({ onNext: e, onUninstall: t }) =>
      a.createElement(
        pe,
    ...
    const Xm = ({
      ...
      const [r, i] = Be('authenticationScreen', n ? 'signin' : 'welcome')
      const [l, o] = Be('exchangeParameters')
      const s = hs()
      const { uninstallAddon: d } = gs()
      const { setSubdomain: c } = qi()
      ...
      if (r === 'subdomain')
        return a.createElement(Eu, { onBack: () => i('signin'), onSignIn: u })
      if (r === 'verify') {
        if (!l)
          throw new Error(
...
`
    ...
    const r4 = ({ gitInfoError: e }) => {
      const t = e?.message.includes('git init')
      const n = t || e?.message.includes('one commit')
      const r = e?.message.includes('user.email')
      return (
              ...
              : a.createElement(
                  ...
                  a.createElement(
                    ...
                    a.createElement(
                      'li',
                      null,
                      t ? a.createElement(Kr, null) : a.createElement(Yr, null),
                      a.createElement(
                        Jr,
                        null,
                        a.createElement(
                    ...
                    a.createElement(
                      'li',
                      null,
                      n ? a.createElement(Kr, null) : a.createElement(Yr, null),
                      a.createElement(
                        Jr,
                        null,
...
`)
    const s4 = ({ projectId: e, configFile: t, goToNext: n }) => {
      Ve('LinkProject', 'LinkedProject')
      const [{ data: r, fetching: i, error: l }] = dl({
        query: o4,
    ...
    function d4(e) {
      ...
      let r = Array.from(typeof e === 'string' ? [e] : e)
      r[r.length - 1] = r[r.length - 1].replace(/\r?\n([\t ]*)$/, '')
      const i = r.reduce(function (s, d) {
        const c = d.match(/\n([\t ]+|(?!\s).)/g)
        return c
          ? s.concat(
              c.map(function (u) {
...
`)),
    ...
    const u4 = 'https://www.chromatic.com/docs/visual-tests-addon/#configure'
...
`)
    ...
    const Fa = k.div({ height: '100%', overflowY: 'auto' })
    const f4 = k(ne)({ width: '100%' })
    const g4 = k(O5)({ marginRight: 10 })
    function v4({
      createdProjectId: e,
      setCreatedProjectId: t,
      onSelectProjectId: n,
    }) {
      const [{ data: r, fetching: i, error: l }, o] = dl({ query: p4 })
      te(() => {
        const h = setInterval(o, 5e3)
        return () => clearInterval(h)
      }, [o])
      const [s, d] = Be('selectedAccountId')
      const c = r?.viewer?.accounts.find(h => h.id === s)
      const u = K(h => d(h.id), [d])
      te(() => {
        !s && r?.viewer?.accounts && u(r.viewer.accounts[0])
      }, [r, s, u])
      const [m, p] = Be('isSelectingProject', !1)
      const v = K(
        h => {
          ;(p(!0), n(h.id))
          const f = setTimeout(() => {
      ...
      const [y, w] = Gs(g)
      const b = e && c?.projects?.find(h => h?.id.endsWith(e))
      return (
        te(() => {
          b && (w(), v(b))
        }, [b, v, w]),
    ...
    const Qs = { isRunning: !1, startBuild: () => {}, stopBuild: () => {} }
    const Xs = He(Qs)
    const sa = () => ht(Xs, 'RunBuild')
    const k4 = ({ children: e, watchState: t = Qs }) =>
    ...
    const e0 = ({
      children: e,
      billingUrl: t,
      suspensionReason: n = 'OTHER',
    }) => {
      Ve('Errors', 'AccountSuspended')
      const { heading: r, message: i, action: l } = zo[n] || zo.OTHER
      return a.createElement(
        pe,
        { footer: null },
        a.createElement(
    ...
    const x4 = ({ children: e, manageUrl: t }) => (
    ...
    const N4 = t0('function')
    const M4 = e => e === null
    const Uo = e => Object.prototype.toString.call(e).slice(8, -1) === 'RegExp'
    const $o = e => !F4(e) && !M4(e) && (N4(e) || typeof e === 'object')
    var F4 = t0('undefined')
    function A4(e, t) {
      const { length: n } = e
    ...
    function T4(e, t) {
      ...
      for (const n of e.entries()) if (!Me(n[1], t.get(n[0]))) return !1
      return !0
    }
    function Z4(e, t) {
      if (e.size !== t.size) return !1
    ...
    A.oneOf = (e, t) => (A.array(e) ? e.includes(t) : !1)
    ...
    function Wo(e, t, n) {
      const { actual: r, key: i, previous: l, type: o } = n
      const s = ot(e, i)
      const d = ot(t, i)
      let c = [s, d].every(O.number) && (o === 'increased' ? s < d : s > d)
      return (
    ...
    const U4 = (function () {
      for (let e = ['Edge', 'Trident', 'Firefox'], t = 0; t < e.length; t += 1)
        if (da && navigator.userAgent.includes(e[t])) return 1
      return 0
    })()
    function $4(e) {
      let t = !1
    ...
    const Jo = da && !!(window.MSInputMethodContext && document.documentMode)
    const Qo = da && /MSIE 10/.test(navigator.userAgent)
    function bn(e) {
    ...
    function hn(e) {
      ...
      return !r || r === 'BODY' || r === 'HTML'
        ...
        : ['TH', 'TD', 'TABLE'].includes(n.nodeName) &&
            $t(n, 'position') === 'static'
          ? hn(n)
          : n
    }
    ...
    function or(e, t) {
      ...
      const o = l.commonAncestorContainer
    ...
    function fn(e) {
      ...
      if (r === 'BODY' || r === 'HTML') {
        ...
        const l = e.ownerDocument.scrollingElement || i
        return l[n]
      }
      return e[n]
    }
    ...
    function l0(e) {
      ...
      const r = bn(10) && getComputedStyle(n)
      return { height: e1('Height', t, n, r), width: e1('Width', t, n, r) }
    }
    const J4 = function (e, t) {
      if (!(e instanceof t))
    ...
    function Ri(e) {
      ...
      const l = e.nodeName === 'HTML' ? l0(e.ownerDocument) : {}
      const o = l.width || e.clientWidth || i.width
      const s = l.height || e.clientHeight || i.height
      let d = e.offsetWidth - o
    ...
    function pl(e, t) {
      ...
      const s = ca(e)
      const d = $t(t)
      const c = parseFloat(d.borderTopWidth)
      const u = parseFloat(d.borderLeftWidth)
      ...
      if (((m.marginTop = 0), (m.marginLeft = 0), !r && i)) {
        const p = parseFloat(d.marginTop)
        const v = parseFloat(d.marginLeft)
        ;((m.top -= c - p),
          (m.bottom -= c - p),
          (m.left -= u - v),
          (m.right -= u - v),
    ...
    function X4(e) {
      ...
      const l = Math.max(n.clientHeight, window.innerHeight || 0)
      const o = t ? 0 : fn(n)
      const s = t ? 0 : fn(n, 'left')
      const d = {
    ...
    function d0(e, t, n, r, i) {
      ...
      const c = d.filter(function (p) {
        const v = p.width
        const g = p.height
        return v >= n.clientWidth && g >= n.clientHeight
      })
      const u = c.length > 0 ? c[0].key : d[0].key
      const m = e.split('-')[1]
      return u + (m ? '-' + m : '')
    }
    function c0(e, t, n) {
    ...
    function u0(e) {
      ...
      const i = parseFloat(n.marginLeft || 0) + parseFloat(n.marginRight || 0)
      const l = { width: e.offsetWidth + i, height: e.offsetHeight + r }
      return l
    }
    function sr(e) {
    ...
    function m0(e, t, n) {
      ...
      const l = ['right', 'left'].includes(n)
      const o = l ? 'top' : 'left'
      const s = l ? 'left' : 'top'
      const d = l ? 'height' : 'width'
      const c = l ? 'width' : 'height'
      return (
        (i[o] = t[o] + t[d] / 2 - r[d] / 2),
    ...
    function tp(e, t, n) {
      ...
      const r = ua(e, function (i) {
        return i[t] === n
      })
      return e.indexOf(r)
    }
    function p0(e, t, n) {
      const r = n === void 0 ? e : e.slice(0, tp(e, 'name', n))
      return (
    ...
    function g0(e, t, n, r) {
      ...
      const l = i ? e.ownerDocument.defaultView : e
    ...
    function Bi(e, t) {
      Object.keys(t).forEach(function (n) {
        let r = ''
        ;(['width', 'height', 'top', 'right', 'bottom', 'left'].includes(n) &&
          gl(t[n]) &&
          (r = 'px'),
          (e.style[n] = t[n] + r))
      })
    ...
    function cp(e, t, n, r, i) {
      const l = c0(i, t, e, n.positionFixed)
      const o = d0(
        n.placement,
        l,
        t,
    ...
    function up(e, t) {
      ...
      const d = l(i.width)
      const c = l(r.width)
      const u = ['left', 'right'].includes(e.placement)
      const m = e.placement.includes('-')
      const p = d % 2 === c % 2
      const v = d % 2 === 1 && c % 2 === 1
      const g = t ? (u || m || p ? l : o) : s
      const y = t ? l : s
      return {
    ...
    const mp = da && /Firefox/i.test(navigator.userAgent)
    function pp(e, t) {
      const n = t.x
      const r = t.y
      const i = e.offsets.popper
      const l = ua(e.instance.modifiers, function (f) {
      ...
      const o = l !== void 0 ? l : t.gpuAcceleration
      const s = hn(e.instance.popper)
      const d = Ri(s)
      const c = { position: i.position }
      const u = up(e, window.devicePixelRatio < 2 || !mp)
      const m = n === 'bottom' ? 'top' : 'bottom'
      const p = r === 'right' ? 'left' : 'right'
      const v = fl('transform')
      let g = void 0
      let y = void 0
      if (
        (m === 'bottom'
        ...
        const w = m === 'bottom' ? -1 : 1
        const b = p === 'right' ? -1 : 1
        ;((c[m] = y * w), (c[p] = g * b), (c.willChange = m + ', ' + p))
      }
      const h = { 'x-placement': e.placement }
      return (
    ...
    function hp(e, t) {
      ...
      const o = l.popper
      const s = l.reference
      const d = ['left', 'right'].includes(i)
      const c = d ? 'height' : 'width'
      const u = d ? 'Top' : 'Left'
      const m = u.toLowerCase()
      const p = d ? 'left' : 'top'
      const v = d ? 'bottom' : 'right'
      const g = u0(r)[c]
      ;(s[v] - g < o[m] && (e.offsets.popper[m] -= o[m] - (s[v] - g)),
        s[m] + g > o[v] && (e.offsets.popper[m] += s[m] + g - o[v]),
        (e.offsets.popper = Ft(e.offsets.popper)))
      const y = s[m] + s[c] / 2 - g / 2
      const w = $t(e.instance.popper)
      const b = parseFloat(w['margin' + u])
      const h = parseFloat(w['border' + u + 'Width'])
      let f = y - e.offsets.popper[m] - b - h
      return (
    ...
    function t1(e) {
      const t =
        arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1
      const n = ei.indexOf(e)
      const r = ei.slice(n + 1).concat(ei.slice(0, n))
    ...
    function gp(e, t) {
      ...
      return (
        o.forEach(function (s, d) {
          ...
          const c = e.offsets.popper
          const u = e.offsets.reference
          const m = Math.floor
          const p =
          ...
          const v = m(c.left) < m(n.left)
          const g = m(c.right) > m(n.right)
          const y = m(c.top) < m(n.top)
          const w = m(c.bottom) > m(n.bottom)
          const b =
            (r === 'left' && v) ||
            (r === 'right' && g) ||
            (r === 'top' && y) ||
            (r === 'bottom' && w)
          const h = ['top', 'bottom'].includes(r)
          const f =
            !!t.flipVariations &&
            ((h && l === 'start' && v) ||
              (h && l === 'end' && g) ||
    ...
    function vp(e) {
      ...
      const i = e.placement.split('-')[0]
      const l = Math.floor
      const o = ['top', 'bottom'].includes(i)
      const s = o ? 'right' : 'bottom'
      const d = o ? 'left' : 'top'
    ...
    function bp(e, t, n, r) {
      const i = [0, 0]
      const l = ['right', 'left'].includes(r)
      const o = e.split(/(\+|\-)/).map(function (u) {
        return u.trim()
      })
      const s = o.indexOf(
        ua(o, function (u) {
      ...
      return (
        (c = c.map(function (u, m) {
          const p = (m === 1 ? !l : l) ? 'height' : 'width'
          let v = !1
          return u
            .reduce(function (g, y) {
              return g[g.length - 1] === '' && ['+', '-'].includes(y)
    ...
    function kp(e, t) {
      let n = t.boundariesElement || hn(e.instance.popper)
      e.instance.reference === n && (n = hn(n))
      const r = fl('transform')
      ...
      const c = t.priority
      let u = e.offsets.popper
      const m = {
        primary: function (p) {
          let v = u[p]
          return (
            u[p] < d[p] && !t.escapeWithReference && (v = Math.max(u[p], d[p])),
            gn({}, p, v)
          )
        },
        secondary: function (p) {
          const v = p === 'right' ? 'left' : 'top'
          let g = u[v]
          return (
            u[p] > d[p] &&
              !t.escapeWithReference &&
              (g = Math.min(u[v], d[p] - (p === 'right' ? u.width : u.height))),
            gn({}, v, g)
          )
        },
      }
      return (
        c.forEach(function (p) {
          const v = ['left', 'top'].includes(p) ? 'primary' : 'secondary'
          u = ze({}, u, m[v](p))
        }),
        (e.offsets.popper = u),
        e
    ...
    function wp(e) {
      ...
      if (r) {
        ...
        const l = i.reference
        const o = i.popper
        const s = ['bottom', 'top'].includes(n)
        const d = s ? 'left' : 'top'
        const c = s ? 'width' : 'height'
        const u = { start: gn({}, d, l[d]), end: gn({}, d, l[d] + l[c] - o[c]) }
    ...
    function Cp(e) {
      ...
      const n = ua(e.instance.modifiers, function (r) {
    ...
    function Sp(e) {
      ...
      const i = r.popper
      const l = r.reference
      const o = ['left', 'right'].includes(n)
      const s = !['top', 'left'].includes(n)
      return (
    ...
    L.oneOf = function (e, t) {
      return L.array(e) ? e.includes(t) : !1
    }
    ...
    function i1(e, t, n) {
      ...
      const s = st(e, i)
      const d = st(t, i)
      let c = [s, d].every(I.number) && (o === 'increased' ? s < d : s > d)
      return (
    ...
    function Dp(e, t) {
      ...
      const o = function (m, p, v) {
        if (!I.defined(m)) return !1
        try {
          return i1(e, t, { key: m, actual: p, previous: v, type: 'decreased' })
        } catch {
          return !1
        }
      }
      ...
      const c = function (m, p, v) {
        if (!I.defined(m)) return !1
        try {
          return i1(e, t, { key: m, actual: p, previous: v, type: 'increased' })
        } catch {
          return !1
        }
      }
      const u = function (m, p) {
        try {
    ...
    const qp = { flip: { padding: 20 }, preventOverflow: { padding: 10 } }
    const Gp =
    ...
    const Tn = Nn.createPortal !== void 0
    function at() {
      return !!(
        typeof window < 'u' &&
        window.document &&
    ...
    function La(e) {
      ...
      const l = e.debug
      const o = l === void 0 ? !1 : l
      const s = i ? console.warn || console.error : console.log
      o &&
        t &&
        n &&
        ...
        pa(n, [
          ...
          },
          {
            ...
            value: function () {
              ...
              const o = Nn.unstable_renderSubtreeIntoContainer(
                this,
    ...
    const a3 = ['color', 'height', 'width']
    function x0(e) {
      const t = e.handleClick
      const n = e.styles
      const r = n.color
      const i = n.height
      const l = n.width
    ...
    function N0(e) {
      const t = e.content
      const n = e.footer
      const r = e.handleClick
      const i = e.open
      const l = e.positionWrapper
      const o = e.showCloseButton
      const s = e.title
      const d = e.styles
      const c = {
        ...
        pa(n, [
          {
            ...
            get: function () {
              const r = this.props
              const i = r.disableAnimation
              const l = r.component
              const o = r.placement
              const s = r.hideArrow
              const d = r.status
              const c = r.styles
              const u = c.arrow.length
              const m = c.floater
              const p = c.floaterCentered
              const v = c.floaterClosing
              const g = c.floaterOpening
              const y = c.floaterWithAnimation
              const w = c.floaterWithComponent
              let b = {}
              return (
                s ||
                  (o.startsWith('top')
                ...
                [ee.OPENING, ee.OPEN].includes(d) && (b = me(me({}, b), g)),
        ...
        pa(n, [
          {
            ...
            value: function () {
              ...
              const i = r.children
              const l = r.handleClick
              const o = r.handleMouseEnter
              const s = r.handleMouseLeave
              const d = r.setChildRef
              const c = r.setWrapperRef
              const u = r.style
              const m = r.styles
              let p
              if (i)
                if (a.Children.count(i) === 1)
                  if (!a.isValidElement(i)) p = a.createElement('span', null, i)
                    ...
                    const v = I.function(i.type) ? 'innerRef' : 'ref'
    ...
    const r3 = { zIndex: 100 }
    function i3(e) {
      const t = (0, Pi.default)(r3, e.options || {})
      return {
        wrapper: {
          cursor: 'help',
          display: 'inline-flex',
    ...
    const l3 = ['arrow', 'flip', 'offset']
    const o3 = ['position', 'top', 'right', 'bottom', 'left']
    const yl = (function (e) {
      ha(n, e)
      const t = fa(n)
      function n(r) {
        ...
        return (
          ...
          xe(vt(i), 'handleTransitionEnd', function () {
            const l = i.state.status
            const o = i.props.callback
          ...
          xe(vt(i), 'handleClick', function () {
            ...
            if (!I.boolean(s)) {
              const d = i.state
              const c = d.positionWrapper
              const u = d.status
              ;(i.event === 'click' || (i.event === 'hover' && c)) &&
                (La({
                  title: 'click',
                  data: [
                    { event: o, status: u === ee.OPEN ? 'closing' : 'opening' },
                  ],
                  debug: i.debug,
                }),
                i.toggle())
          ...
          xe(vt(i), 'handleMouseLeave', function () {
            const l = i.props
            const o = l.event
            const s = l.eventDelay
            const d = l.open
            if (!(I.boolean(d) || ni())) {
              const c = i.state
              const u = c.status
              const m = c.positionWrapper
              i.event === 'hover' &&
                (La({
                  title: 'mouseLeave',
                  data: [{ key: 'originalEvent', value: o }],
        ...
        pa(n, [
          ...
          },
          {
            ...
            value: function (r, i) {
              if (at()) {
                ...
                const s = l.open
                const d = l.target
                const c = l.wrapperOptions
                const u = Dp(i, this.state)
                const m = u.changedFrom
                const p = u.changed
                if (r.open !== s) {
                  let v
            ...
            value: function () {
              ...
              const i =
                arguments.length > 0 && arguments[0] !== void 0
                  ? arguments[0]
                  : this.target
              const l = this.state.positionWrapper
              const o = this.props
              const s = o.disableFlip
              const d = o.getPopper
              const c = o.hideArrow
              const u = o.offset
              const m = o.placement
              const p = o.wrapperOptions
              const v =
                m === 'top' || m === 'bottom'
                  ? 'flip'
                  : [
              ...
              if (m === 'center') this.setState({ status: ee.IDLE })
                ...
                new n1(i, this.floaterRef, {
                  ...
                  onUpdate: function (E) {
                    r.popper = E
                    const C = r.state.currentPlacement
                    r._isMounted &&
                      E.placement !== C &&
              ...
              if (l) {
                const f = I.undefined(p.offset) ? 0 : p.offset
          ...
          },
          {
            ...
            value: function (r) {
              ...
              let l = i === ee.OPEN ? ee.CLOSING : ee.OPENING
          ...
          },
          {
            ...
            get: function () {
              ...
              const i = this.state
              const l = i.status
              const o = i.positionWrapper
              const s = i.statusWrapper
              const d = this.props.styles
              const c = (0, Pi.default)(i3(d), d)
              if (o) {
                let u
                ;(![ee.IDLE].includes(l) || ![ee.IDLE].includes(s)
                  ? (u = c.wrapperPosition)
                  : (u = this.wrapperPopper.styles),
                  (c.wrapper = me(me({}, c.wrapper), u)))
              }
              if (this.target) {
                const m = window.getComputedStyle(this.target)
                this.wrapperStyles
                  ? (c.wrapper = me(me({}, c.wrapper), this.wrapperStyles))
                  : !['relative', 'static'].includes(m.position) &&
                    ((this.wrapperStyles = {}),
                    o ||
          ...
          },
          {
            ...
            value: function () {
              const r = this.state
              const i = r.currentPlacement
              const l = r.positionWrapper
              const o = r.status
              const s = this.props
              const d = s.children
              const c = s.component
              const u = s.content
              const m = s.disableAnimation
              const p = s.footer
              const v = s.hideArrow
              const g = s.id
              const y = s.open
              const w = s.showCloseButton
              const b = s.style
              const h = s.target
              const f = s.title
    ...
    const s3 = pt(Vd(), 1)
    const d3 = Object.defineProperty
    const c3 = (e, t, n) =>
      t in e
        ? d3(e, t, { enumerable: !0, configurable: !0, writable: !0, value: n })
        : (e[t] = n)
    const _ = (e, t, n) => (c3(e, typeof t !== 'symbol' ? t + '' : t, n), n)
    const ie = {
      INIT: 'init',
      START: 'start',
      STOP: 'stop',
    ...
    function g3(e, t, n) {
      let r
      if (!e) return 0
      const { offsetTop: i = 0, scrollTop: l = 0 } =
        (r = (0, a0.default)(e)) != null ? r : {}
      let o = e.getBoundingClientRect().top + l
      i && (Fr(e, n) || p3(e)) && (o -= i)
    ...
    function b3(e) {
      ...
      const n = e.replace(t, (i, l, o, s) => l + l + o + o + s + s)
      const r = /^#?([\da-f]{2})([\da-f]{2})([\da-f]{2})$/i.exec(n)
      return r
    ...
    const g1 = { borderRadius: 4, position: 'absolute' }
    function x3(e, t) {
      const n = (0, Xr.default)(e ?? {}, t ?? {})
      const r = (0, Xr.default)(S3, n.options || {})
      let { width: i } = r
    ...
    function _n(e, t) {
      let n, r, i, l, o, s
      const d = e ?? {}
      const c = Aa.default.all([w3, N3(t), d], {
        isMergeableObject: O.plainObject,
      })
      const u = x3(t.styles, c.styles)
      const m = Fr(Mt(c.target), c.disableScrollParentFix)
      const p = Aa.default.all([
        k3,
    ...
    const y1 = ['action', 'index', 'lifecycle', 'status']
    const F3 = class {
      constructor(e) {
        ;(_(this, 'beaconPopper'),
          ...
          _(this, 'setSteps', i => {
            const { size: l, status: o } = this.getState()
            const s = { size: i.length, status: o }
          ...
          _(this, 'close', () => {
            const { index: i, status: l } = this.getState()
            l === J.RUNNING &&
              this.setState({
          ...
          _(this, 'go', i => {
            const { controlled: l, status: o } = this.getState()
            if (l || o !== J.RUNNING) return
            const s = this.getSteps()[i]
            this.setState({
          ...
          _(this, 'reset', (i = !1) => {
            const { controlled: l } = this.getState()
            l ||
              this.setState({
          ...
          _(this, 'start', i => {
            const { index: l, size: o } = this.getState()
            this.setState({
              ...this.getNextState(
          ...
          _(this, 'stop', (i = !1) => {
            const { index: l, status: o } = this.getState()
      ...
      getNextState(e, t = !1) {
        ...
        const m = O.number(e.index) ? e.index : d
        const p = s && !t ? d : Math.min(Math.max(m, 0), c)
        return {
      ...
      hasUpdatedState(e) {
        ...
        const n = JSON.stringify(this.getState())
        return t !== n
      }
      setState(e, t = !1) {
    ...
    const T3 = class extends Tt {
      ...
      render() {
        ...
        const c = O.string(i.open) ? i.open : (0, s3.default)(i.open)
        const u = {
          'aria-label': c,
          onClick: l,
          onMouseEnter: l,
    ...
    const _3 = class extends Tt {
      constructor() {
        ;(super(...arguments),
          ...
          _(this, 'handleMouseMove', e => {
            ...
            const s = i === 'fixed' ? e.clientY : e.pageY
            const d = i === 'fixed' ? e.clientX : e.pageX
            const c = s >= l && s <= l + n
            const u = d >= r && d <= r + o && c
      ...
      componentDidUpdate(e) {
        ...
        const { changed: i } = lr(e, this.props)
      ...
      render() {
        ...
        let u = o !== 'center' && t && S(O3, { styles: this.spotlightStyles })
        if (L0() === 'safari') {
          const { mixBlendMode: m, zIndex: p, ...v } = c
    ...
    function R3({ styles: e, ...t }) {
      const { color: n, height: r, width: i, ...l } = e
      return a.createElement(
        'button',
    ...
    function P3(e) {
      ...
      const { back: E, close: C, last: Z, next: M, skip: V } = y
      const D = { primary: C }
      return (
        r &&
          ((D.primary = l ? Z : M),
    ...
    const H3 = class extends Tt {
      constructor() {
        ;(super(...arguments),
          ...
          _(this, 'getElementsProps', () => {
            ...
            const i = Nt(r.locale.back)
            const l = Nt(r.locale.close)
            const o = Nt(r.locale.last)
            const s = Nt(r.locale.next)
            const d = Nt(r.locale.skip)
            let c = e ? s : l
            return (
              t && (c = o),
              {
      ...
      render() {
        ...
        const { beaconComponent: o, tooltipComponent: s, ...d } = l
        let c
        if (s) {
          const u = {
    ...
    const j3 = class extends Tt {
      constructor() {
        ;(super(...arguments),
          ...
          _(this, 'handleClickOverlay', () => {
            const { helpers: e, step: t } = this.props
          ...
          _(this, 'setPopper', (e, t) => {
            let n
            const { action: r, step: i, store: l } = this.props
            ;(t === 'wrapper'
      ...
      componentDidUpdate(e) {
        ...
        const { changed: v, changedFrom: g } = lr(e, this.props)
        const y = {
          action: n,
          controlled: l,
          index: s,
        ...
        const w = i && n !== ie.CLOSE && (s > 0 || n === ie.PREV)
        const b = v('action') || v('index') || v('lifecycle') || v('status')
        const h = g('lifecycle', [q.TOOLTIP, q.INIT], q.INIT)
        const f = v('action', [ie.NEXT, ie.PREV, ie.SKIP, ie.CLOSE])
        const E = l && s === e.index
        if (
          (f &&
            (h || E) &&
    ...
    const O0 = class extends Tt {
      constructor(e) {
        ;(super(e),
          ...
          _(this, 'handleKeyboard', o => {
            const { index: s, lifecycle: d } = this.state
            const { steps: c } = this.props
            const u = c[s]
            d === q.TOOLTIP &&
              o.code === 'Escape' &&
              u &&
        ...
        const { addListener: l } = this.store
        ;(Ut({
          title: 'init',
          data: [
      ...
      componentDidUpdate(e, t) {
        ...
        const { debug: s, run: d, stepIndex: c, steps: u } = this.props
        const { stepIndex: m, steps: p } = e
        const {
          reset: v,
          setSteps: g,
          start: y,
        ...
        const { changed: h } = lr(e, this.props)
        const { changed: f, changedFrom: E } = lr(t, this.state)
        const C = _n(u[i], this.props)
        const Z = !Me(p, u)
        const M = O.number(c) && h('stepIndex')
        const V = Mt(C.target)
        if (
        ...
        const D = { ...this.state, index: i, step: C }
        if (
          f('action', [ie.NEXT, ie.PREV, ie.SKIP, ie.CLOSE]) &&
          f('status', J.PAUSED)
        ) {
          const X = _n(u[t.index], this.props)
          this.callback({
            ...D,
            index: t.index,
            lifecycle: q.COMPLETE,
      ...
      scrollToStep(e) {
        ...
        if (r === J.RUNNING && p) {
          ...
          const w = this.store.getPopper('beacon')
          const b = this.store.getPopper('tooltip')
          if (n === q.BEACON && w) {
            const { offsets: h, placement: f } = w
            !['bottom'].includes(f) && !v && (y = Math.floor(h.popper.top - s))
          } else if (n === q.TOOLTIP && b) {
            const { flipped: h, offsets: f, placement: E } = b
    ...
    function bl(e) {
      ...
      const d = e.length
        ...
        : {}
      const c = Object.entries(l).map(([m, p]) => ({
        browser: d[m],
        result: p,
      }))
      const u = Object.entries(o).map(([m, p]) => ({ mode: s[m], result: p }))
      return {
        status: z3(t),
        isInProgress: n,
        changeCount: r,
    ...
    const _0 = ({ result: e }) =>
      e && !['EQUAL', 'FIXED', 'SKIPPED'].includes(e)
    const $3 = (e, t) => {
      const n = e.filter(i => i.comparisons.some(_0))
      const r = n.length ? n : e
...
`)
    const e7 = ({
      ...
      const [{ data: i, error: l, operation: o }, s] = dl({
        query: G3,
        variables: {
          projectId: e,
          storyId: t,
      ...
      te(() => {
        const y = setInterval(s, 5e3)
        return () => clearInterval(y)
      }, [s])
      const d = o && t && o.variables.storyId !== t
      const c = an(Y3, i?.project?.lastBuildOnBranch)
      const u = [
        ...an(
          J3,
      ...
      const m = c?.committedAt > n.committedAt
      const p = !!c && !m
      const v = !!c && u.every(y => y.status !== 'IN_PROGRESS')
      const g = an(
        K3,
    ...
    const El = He(null)
    const R0 = He(null)
    const t7 = () => ht(El, 'Build')
    const B0 = () => {
      const { selectedBuild: e } = ht(El, 'Build')
      if (!e) throw new Error('No selectedBuild on Build context')
      return e
    }
    const Wt = () => ht(R0, 'Story')
    const ai = ({ children: e, watchState: t }) => {
      const n = !!t?.selectedBuild && 'testsForStory' in t.selectedBuild
      const r =
        t?.selectedBuild &&
    ...
    const l7 = k.div(({ theme: e }) => ({
      fontSize: 13,
      lineHeight: '18px',
      fontWeight: 700,
      color: e.color.defaultText,
    }))
    const o7 = k.div(({ theme: e }) => ({
      fontSize: 13,
      lineHeight: '18px',
      textAlign: 'start',
      color: e.color.defaultText,
    ...
    const d7 = ({ isLastStep: e, step: t, primaryProps: n, tooltipProps: r }) =>
      a.createElement(
        r7,
        { ...r },
        a.createElement(
    ...
    const c7 = ({
      ...
      const i = Sn()
      const l = Wt()
      const o = l?.selectedTest?.result === 'CHANGED'
      const s = l?.selectedTest?.status !== 'ACCEPTED'
      const d = JSON.stringify(wn().layout)
      const c = Ee(d)
      ;(c.current !== d &&
      ...
      const [u, m] = Be('showConfetti', !1)
      const [p, v] = Be('stepIndex', 0)
      const g = () => v((y = 0) => y + 1)
      return (
        te(() => {
          const y = document.getElementById('storybook-explorer-tree')
          const w = Array.from(y instanceof HTMLElement ? y.children : [])
    ...
    const P0 = ({ localBuildProgress: e, title: t }) =>
      a.createElement(
        u7,
        { warning: !0 },
        a.createElement(
    ...
    const p7 = ({ children: e, localBuildProgress: t }) => (
    ...
    const ji = ['initialize', 'build', 'upload', 'verify', 'snapshot']
    const kl = {
      initialize: {
        key: 'initialize',
        emoji: '\u{1F680}',
      ...
      upload: {
        ...
        renderProgress: ({ stepProgress: e }) => {
          const { numerator: t, denominator: n } = e.upload
          if (!n || !t) return 'Uploading files...'
          const { value: r, exponent: i } = Hr(n, {
            output: 'object',
            round: 1,
          })
          const { value: l, symbol: o } = Hr(t, {
            exponent: i,
            output: 'object',
            round: 1,
          })
      ...
      snapshot: {
        ...
        renderProgress: ({ stepProgress: e }) => {
          const { numerator: t, denominator: n } = e.snapshot
          return n
    ...
    JSON.stringify(h7)
    const V0 = ({ localBuildProgress: e, withEmoji: t = !1, ...n }) => {
      const { emoji: r, renderProgress: i } = kl[e.currentStep]
      const l = i(e)
    ...
    const H0 = k.div(({ theme: e }) => ({
      height: 5,
      background: e.background.hoverable,
      borderRadius: 5,
      overflow: 'hidden',
    }))
    const g7 = k(H0)(({ theme: e }) => ({
    ...
    const C7 = k(j)(({ theme: e }) => ({ color: e.color.darkest }))
    const S7 = ({ onSkip: e, runningSecondBuild: t }) =>
      a.createElement(
        pe,
        { footer: null },
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(re, { link: !0, onClick: e }, 'Skip walkthrough')
            )
          )
        )
      )
    ...
    const M7 = ({ isUnchanged: e, localBuildProgress: t, ...n }) => (
    ...
    const F7 = k.div(({ status: e, theme: t }) => ({
      position: 'relative',
      display: 'inline-flex',
    ...
    const Di = ({ backgroundColor: e, status: t, thumbnailUrl: n }) =>
      a.createElement(
        F7,
        { status: t },
        a.createElement(
    ...
    const k1 = k(j)({ marginBottom: 5 })
    const w1 = ({ onComplete: e, onSkip: t, ranSecondBuild: n = !1 }) => {
    ...
    const T7 = k(j)({ marginBottom: 5 })
    const Z7 = ({ onCatchAChange: e, onSkip: t }) => {
        ...
        a.createElement(
          ...
          a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(re, { link: !0, onClick: t }, 'Skip walkthrough')
            )
          )
        )
      )
    ...
    const O7 = ({
      ...
      const { isRunning: s, startBuild: d } = sa()
      const [c, u] = Be('showInitialBuild', n)
      te(() => {
        n && u(!0)
      }, [n, u])
      const [m, p] = Be('showCatchAChange', !c)
      const [v, g] = Be('initialGitHash', r.uncommittedHash)
      const y = () => {
        ;(g(r.uncommittedHash), p(!0))
      }
      const [w, b] = Be('runningSecondBuild', !1)
      return t?.currentStep === 'error'
        ? a.createElement(
            ...
            a.createElement(
              ...
              a.createElement(re, { link: !0, onClick: o }, 'Skip walkthrough')
            )
          )
    ...
    const R7 = k(ps)({ animation: `${I7} 1s linear infinite` })
    const Ta = { width: 10, marginRight: 8 }
    const S1 = k.button(({ isWarning: e, onClick: t, theme: n }) => {
      const r = n.base === 'light' ? n.background.warning : '#2e271a'
      return {
        position: 'relative',
        display: 'flex',
        width: '100%',
    ...
    const x1 = k.div(({ isWarning: e, percentage: t, theme: n }) => {
      const r = n.base === 'light' ? '#FFE6B1' : '#43361f'
      return {
        display: 'block',
        position: 'absolute',
        top: '0',
    ...
    const Za = k.div({ lineHeight: '21px', padding: '4px 0' })
    const B7 = k(Lc)({ transition: 'transform 0.1s ease-in-out' })
    const P7 = k.div(({ expanded: e, theme: t }) => ({
      display: 'grid',
    ...
    const V7 = k.div(({ theme: e }) => ({
      whiteSpace: 'nowrap',
      overflow: 'hidden',
      color: e.base === 'light' ? e.color.dark : e.color.lightest,
    }))
    const H7 = k.div(
      ({ isCurrent: e, isFailed: t, isPending: n, theme: r }) => ({
        display: 'flex',
        flexDirection: 'row',
        gap: 8,
        opacity: n ? 0.7 : 1,
    ...
    const j7 = ({ localBuildProgress: e, expanded: t = !1 }) => {
      const n = Ee({})
      te(() => {
        n.current[e.currentStep] = { ...e }
      }, [e])
      const r = ['aborted', 'error'].includes(e.currentStep)
      const i = ji.map(l => {
        const { startedAt: o, completedAt: s } = e.stepProgress[l]
        const d = !!o && !s
        const c = d && r
        const u = !o
        const m = { ...kl[l], isCurrent: d, isFailed: c, isPending: u }
        return c
          ? {
              ...m,
    ...
    const D7 = ({
      ...
      if (n) {
        const c = n.currentStep === 'aborted'
        const u = n.currentStep === 'error'
        const m = c || u
        return a.createElement(
          a.Fragment,
          null,
    ...
    const z7 = ({ onClose: e }) =>
      a.createElement(
        ...
        a.createElement(
          Ei,
          null,
          a.createElement(Ha, null, 'Bounding box', a.createElement(po, null)),
          a.createElement(
            'dl',
            null,
    ...
    const D0 = He(j0)
    const z0 = () => ht(D0, 'ReviewTest')
    const U7 = ({ children: e, watchState: t = j0 }) =>
    ...
    const W7 = k(ne)({ margin: '30px 15px' })
    const q7 = ({
    ...
    const G7 = ({
      ...
      const p = Sn()
      const v = !!i && !!s && r === 'CHANGED'
      const g = r === 'CAPTURE_ERROR'
      const y = v && !!d
      const w = v
        ? { as: 'a', href: n, target: '_blank', title: 'View on Chromatic.com' }
        : {}
      const b = v && c
      const h = y && u
      const [f, E] = a.useState(!1)
      const [C, Z] = a.useState(!1)
      const [M, V] = a.useState(!1)
      const [D, X] = a.useState(!1)
      const oe = o ? C : f
      const ve = q7({
    ...
    const $0 = ({ status: e }) => a.createElement(U0, { status: e })
    const K7 = k.div({
      position: 'relative',
      display: 'inline-flex',
      justifyContent: 'center',
    ...
    const th = ({
      ...
      const s =
        ...
        n
          ...
          .sort((d, c) => {
            if (!t) return 0
            const u = t.indexOf(d.title)
            const m = t.indexOf(c.title)
    ...
    const L1 = () => {
      const e = Wt()
      const { browserResults: t, modeResults: n } = e.summary
      return a.createElement(
        br,
        null,
        n.length > 0 &&
    ...
    const nh = ({ theme: e, status: t, variant: n }) =>
      n === 'outline'
        ? {
    ...
    const T1 = k.div({ display: 'flex', flexDirection: 'row' })
    const ur = k.div(
      ({ theme: e }) => ({
        width: 12,
        height: 12,
    ...
    const rh = k.div(({ theme: e }) => ({
      padding: 9,
      '> svg': { display: 'block' },
      path: { fill: e.color.mediumdark },
    }))
    const ih = k.div(({ theme: e, showDivider: t }) => ({
      gridArea: 'actions',
      display: 'flex',
      alignItems: 'center',
      justifyContent: 'flex-end',
    ...
    const lh = ({ isOutdated: e }) => {
      const { baselineImageVisible: t, diffVisible: n, focusVisible: r } = vr()
      const { toggleBaselineImage: i, toggleDiff: l, toggleFocus: o } = vn()
      const { isRunning: s, startBuild: d } = sa()
      const { selectedTest: c, selectedComparison: u, summary: m } = Wt()
      const { changeCount: p, isInProgress: v } = m
      const {
        isReviewing: g,
        buildIsReviewable: y,
        userCanReview: w,
      ...
      const f = p > 0 && c?.status !== 'ACCEPTED'
      const E = p > 0 && c?.status === 'ACCEPTED'
      const C = u?.result === 'CHANGED'
      return a.createElement(
        a.Fragment,
        null,
        C &&
          ...
          a.createElement(
            ...
            w &&
              ...
              a.createElement(
                ...
                a.createElement(
                  ke,
                  {
                    tooltip: a.createElement(Ie, { note: 'Accept this story' }),
                    trigger: 'hover',
                    hasChrome: !1,
                  },
                  a.createElement(
            ...
            !(w && y) &&
              a.createElement(
                ke,
                {
                  tooltip: a.createElement(Ie, { note: 'Reviewing disabled' }),
                  trigger: 'hover',
                  hasChrome: !1,
                },
    ...
    function li(e) {
      return function () {
        ...
        const r = e.formats[n] || e.formats[e.defaultWidth]
        return r
      }
    }
    const fh = {
    ...
    function In(e) {
      return function (t, n) {
        ...
        if (r === 'formatting' && e.formattingValues) {
          ...
          const o = n != null && n.width ? String(n.width) : l
          i = e.formattingValues[o] || e.formattingValues[l]
        } else {
          const s = e.defaultWidth
          const d = n != null && n.width ? String(n.width) : e.defaultWidth
    ...
    function _h(e) {
      return function (t) {
        ...
        if (!r) return null
        const i = r[0]
        const l = t.match(e.parsePattern)
        if (!l) return null
    ...
    const Ph = { any: [/^b/i, /^(a|c)/i] }
    const Vh = {
      narrow: /^[1234]/i,
      abbreviated: /^q[1234]/i,
      wide: /^[1234](th|st|nd|rd)? quarter/i,
    }
    const Hh = { any: [/1/i, /2/i, /3/i, /4/i] }
    const jh = {
      narrow: /^[jfmasond]/i,
    ...
    function Qh(e, t, n) {
      ...
      const c = G0(Jh(n), { addSuffix: !!n?.addSuffix, comparison: d })
      let u
      let m
    ...
    const Bn = k.div(({ theme: e }) => ({
      ...
      lineHeight: '18px',
      color:
        e.base === 'light' ? `${e.color.defaultText}99` : `${e.color.light}99`,
      fontSize: e.typography.size.s2,
      b: {
        color:
    ...
    const r6 = ({
      ...
      const y = !e && n && n6(new Date(n).getTime())
      const w = e || u
      const b = r || c === 'FAILED'
      const h = b || c === 'BROKEN'
      const f = (h || i) && !w && !m
  ...
  `,
    ...
    const l6 = k.div(({ children: e, theme: t }) => ({
      display: 'flex',
      alignItems: 'center',
    ...
    const s6 = ({
      ...
      const { baselineImageVisible: s, diffVisible: d, focusVisible: c } = vr()
      const {
      ...
      const v = B0()
      const g = 'startedAt' in v && v.startedAt
      const y = Wt()
      const { tests: w } = y
      const b = a.useRef(o)
      const h = a.useRef(y.selectedComparison?.id)
      const f = a.useRef(v.id)
      const { selectedTest: E, selectedComparison: C } = y
      const Z = w.every(
        ({ result: fe, status: ce }) => fe === 'ADDED' && ce !== 'ACCEPTED'
      )
      const M = !Z && E?.result === 'ADDED' && E?.status !== 'ACCEPTED'
      const V =
        !Z &&
        C?.result === 'ADDED' &&
        E?.result !== 'ADDED' &&
    ...
    const d6 = k(Tl)({ padding: '4px 8px', margin: '0 6px' })
    const c6 = ({ onClose: e }) =>
      a.createElement(
        ys,
        null,
    ...
    const u6 = ({
      ...
      const { settingsVisible: o, warningsVisible: s } = vr()
      const { toggleSettings: d, toggleWarnings: c } = vn()
      const { isRunning: u, startBuild: m, stopBuild: p } = sa()
      const {
        lastBuildOnBranch: v,
      ...
      const w = B0()
      const b = Wt()
      const { buildIsReviewable: h, userCanReview: f } = z0()
      const E = !!(!h && g && y && i)
      const C = v?.status === 'IN_PROGRESS'
      const Z = u || (!h && !E)
      const M = r && r?.buildId === v?.id
      const V =
        Z &&
        a.createElement(D7, {
          branch: e,
      ...
      const D = b?.hasTests && b?.tests.length === 0
      const X = w.id !== `Build:${r?.buildId}`
      if (D)
        return a.createElement(
          pe,
          null,
      ...
      const { status: oe } = w
      const ve = ['ANNOUNCED', 'PUBLISHED', 'PREPARED'].includes(oe)
      const fe = oe === 'FAILED'
      const ce = oe === 'PENDING' && (!f || !h)
      return a.createElement(
        pe,
        { footer: null },
        a.createElement(
                        ...
                        a.createElement(
                          ...
                          a.createElement(
                            ...
                            a.createElement(
                              ...
                              c ? 'disable' : u ? 'disableSnapshot' : 'docsOnly'
                            ),
...
`)
    const f6 = ({ lastBuildOnBranch: e, vtaOnboarding: t }) => {
      const n = Zt()
      const { notifications: r, storyId: i } = wn()
      const [l, o] = a.useState(!1)
      const s = a.useCallback(() => {
        ;(o(!0), r.forEach(({ id: h }) => n.clearNotification(h)))
      }, [n, r])
      const [d, c] = a.useState(!1)
      const u = a.useCallback(() => c(!0), [])
      const [m, p] = a.useState(!0)
      a.useEffect(() => {
    ...
    const g6 = ({
      ...
      const u = Zt()
      const { addNotification: m, setOptions: p, togglePanel: v } = u
      const g = e7({
        projectId: s,
        storyId: c,
        gitInfo: d,
    ...
    const v6 = e => {
      const [t, n] = Be('selectedBuildInfo')
    ...
    const Y0 = ({ localBuildProgress: e, accessToken: t }) => {
      const n = ya({})
      const r = Gt(hr)
      const [i, l] = Le(!1)
      const [o, s] = Le(!1)
      const d = e
        ...
        : !1
      const c = e
        ? !['aborted', 'complete', 'error', 'limited'].includes(e.currentStep)
        : i
      const u = ft(
        () =>
          bi(
    ...
    const K0 = () => {
      const [e, t] = we(U1)
      const { projectId: n, written: r, dismissed: i, configFile: l } = e || {}
      return {
        loading: !e,
        projectId: n,
        configFile: l,
        updateProject: K(o => t({ ...e, projectId: o, dismissed: !1 }), [e, t]),
    ...
    const b6 = ({ active: e }) => {
      ...
      const [C, Z] = Be('createdProjectId')
      const [M, V] = we(q1)
      const [D, X] = Be('subdomain', 'www')
      const oe = K(tt => p(qd, tt), [p])
      const {
        isRunning: ve,
        startBuild: fe,
        stopBuild: ce,
      ...
      const be = y6()
      const wt = globalThis.LOGLEVEL === 'debug' ? globalThis.fetch : be
      const ge = tt =>
        a.createElement(
          D2,
          { value: Vs({ fetch: wt }) },
    ...
    const w6 = k.div({ display: 'flex', gap: 4 })
    const C6 = k.div(({ crashed: e, theme: t }) => ({
      fontSize: t.typography.size.s1,
      fontWeight: e ? 'bold' : 'normal',
      color: e ? t.color.negativeText : t.color.defaultText,
    }))
    const S6 = k.div(({ theme: e }) => ({
      fontSize: e.typography.size.s1,
      color: e.textMutedColor,
    }))
    const x6 = k(_l)({ margin: 4 })
    const N6 = k(pc)({ width: 10 })
    const M6 = () => {
      const {
        addNotification: e,
        selectStory: t,
      ...
      const [p] = we(W1)
      const [v] = we(Wi)
      const g = Object.keys(v?.problems || {}).length > 0
      const [y] = we(z1)
      const w = Ee(p?.currentStep)
      const { index: b, storyId: h, viewMode: f } = wn()
      const E = Nl(ce => ce[ci] ?? 'test-provider-state:pending')
      const { startBuild: C, stopBuild: Z } = Y0({
      ...
      const V = !M && E !== 'test-provider-state:crashed'
      const D = K(() => {
        V && C()
      }, [V, C])
      ...
      const X = K(
        ce => {
          if ((n({ selectedPanel: rn }), r(!0), b && f !== 'story')) {
            const be = Object.keys(b).indexOf(h)
            const wt = Object.entries(b).slice(be > 0 ? be : 0)
            const [ge] = wt.find(([, { type: kn }]) => kn === 'story') || []
            ge && t(ge)
          }
            ...
            : E === 'test-provider-state:running'
              ? a.createElement(
                  ke,
                  {
                    hasChrome: !1,
                    trigger: 'hover',
                    tooltip: a.createElement(ba, { note: 'Stop Visual tests' }),
                  },
                  a.createElement(
                    xn,
                    {
